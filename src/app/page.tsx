...
const features = [
  ...
  { icon: Heart, title: 'مجتمع نشط', desc: 'انضم لمجتمع阿拉伯ي يشارك خبراته وتجاربه' },
];
...
const testimonials = [
  {
    ...
    role: 'مطور ويب',
    avatar: null,
    content: 'منصة رائعة ساعدتني على اكتشاف أدوات جديدة恍惚 تساعدني في عملي اليومي. أنصح بها بشدة!',
    rating: 5,
  },
  {
    id: '2',
        ...
        <div className="container-custom">
          <div className="flex h-16 md:h-20 items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-3">
              <Link href="/tools">
                <Button size="sm" variant="outline">تصفح الأدوات</Button>
              </Link>
              <Link href="/admin">
          ...
          <Card className="bg-gradient-to-br from-primary-50 to-secondary-50 border-primary/20 overflow-hidden">
            <CardContent className="p-8 md:p-12 text-center">
              <div className="max-w-2xl mx-auto">
                ...
                <p className="text-xs text-dashed text-muted-foreground mt-4">
